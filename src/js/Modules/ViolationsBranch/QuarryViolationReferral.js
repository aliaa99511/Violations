...
quarryViolationReferral.exportToExcel = () => {
    ...
    const columns = [
        ...
        },
        {
            ...
            render: (record) => functions.getDisplayValue(record.TotalPriceDue, true),
        },
        {
            title: "حالة المخالفة",
            render: (record) =>
    ...
    if (Referrals && Referrals.length > 0) {
        Referrals.forEach((referral) => {
            ...
            data.push([
                ...
                `<div class="totalPriceDue">${functions.getDisplayValue(referral.TotalPriceDue, true)}</div>`,
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group customFormGroup">
                                        ...
                                        <input class="form-control disabled customInput currentViolationAmount" id="currentViolationAmount" type="text" value="${functions.getDisplayValue(currentAmount, true)}" disabled>
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-group customFormGroup">
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group customFormGroup">
                                        ...
                                        <input class="form-control disabled customInput currentReferralAmount" id="currentReferralAmount" type="text" value="${functions.getDisplayValue(currentReferredAmount, true)}" disabled>
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-group customFormGroup">
                            ...
                            <div class="row">
                                <div class="col-md-4">
                                    <div class="form-group customFormGroup">
                                        ...
                                        <input class="form-control disabled customInput referredAmountValue" id="referredAmountValue" type="text" value="${functions.getDisplayValue(totalPrice, true)}" disabled>
                                    </div>
                                </div>
                                <div class="col-12">
                                    <div class="form-group customFormGroup">
