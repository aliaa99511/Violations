...
quarryViolationReferral.QuarryViolationReferralTable = (Referrals, destroyTable) => {
    ...
    if (Referrals && Referrals.length > 0) {
        Referrals.forEach((referral) => {
            ...
            if (canShowDetailsOnly) {
                ...
                // Add petition option for all non-Paid statuses
                actionsMenuHTML += `
    ...
    $(document).off('click', '.requestPetition').on('click', '.requestPetition', function (e) {
        ...
        $(".overlay").addClass("active");
        quarryViolationReferral.requestNewPetition(taskId, violationId, violationCode);
        $(".hiddenListBox").hide(300);
    });
...
/////////////////////////////////////
quarryViolationReferral.requestNewPetition = (
    violationTaskID,
    violationID,
    violationCode,
) => {
                ...
                functions
                    ...
                    .then((data) => {
                        if (data.d.Status) {
                            ...
                            quarryViolationReferral.addNewPetitionAttachment(id, "Petitions");
                        } else {
                            $(".overlay").removeClass("active");
...
quarryViolationReferral.addNewPetitionAttachment = (petitionID, ListName) => {
    let Data = new FormData();
